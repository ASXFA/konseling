...
class Model_siswa extends CI_Model {
    var $table = 'tbl_siswa';
    var $select_column = array('id_siswa','induk_siswa','nama_siswa','alamat_siswa','jk_siswa','ortu_siswa');
    var $order_column = array(null,'id_siswa','induk_siswa','nama_siswa','alamat_siswa','jk_siswa','ortu_siswa',null);
    ...
    function make_query()
    {
        ...
        if (isset($_POST['search']['value'])) {
            ...
            $this->db->or_like('ortu_siswa',$_POST['search']['value']);
        }
